...
/* 4 */
/*!************************************************!*\
  !*** F:/HBuilderX/qrcode-to-poster/pages.json ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 17 */
/*!******************************************************!*\
  !*** F:/HBuilderX/qrcode-to-poster/util/js_tools.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.getUserInfo = getUserInfo;exports.downLoadAndSaveFile = downLoadAndSaveFile;exports.getQRCodeBase64 = getQRCodeBase64;exports.writeBase64ToFile = writeBase64ToFile;exports.canvasToImageFile = canvasToImageFile;exports.downloadImageAndGetBase64AndDrawPoster = downloadImageAndGetBase64AndDrawPoster;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@vue/babel-preset-app/node_modules/@babel/runtime/regenerator */ 18));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};} //微信日志输出
var wxlog = __webpack_require__(/*! ./log.js */ 21);
// 绘制最终展示海报时的错误次数
...
function downLoadAndSaveFile(url) {
  wx.getSavedFileList({ // 获取文件列表
    success: function success(res) {
      res.fileList.forEach(function (val, key) {// 遍历文件列表里的数据
        wx.removeSavedFile({
          ...
          success: function success(d_res) {
            ...
            if (d_res && d_res.tempFilePath) {
              ...
              uni.compressImage({
                ...
                success: function success(c_res) {
...
function writeBase64ToFile(base64) {
  return new Promise( /*#__PURE__*/function () {var _ref2 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2(resolve, reject) {var filePath;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
              filePath = "".concat(wx.env.USER_DATA_PATH, "/userQRCodeImage.jpeg");
...
function canvasToImageFile(_this) {
  return new Promise( /*#__PURE__*/function () {var _ref3 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee3(resolve, reject) {return _regenerator.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:
              setTimeout(function () {
                uni.showToast({
                  mask: true,
                  icon: 'none',
                ...
                _this);
              }, canvasToImageFileDelayTime);case 1:case "end":return _context3.stop();}}}, _callee3);}));return function (_x5, _x6) {return _ref3.apply(this, arguments);};}());
...
function downloadImageAndGetBase64AndDrawPoster(_this) {
  return new Promise( /*#__PURE__*/function () {var _ref4 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee4(resolve, reject) {var ctx, savedFilePath;return _regenerator.default.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:
              ctx = uni.createCanvasContext('CANVAS_ID');
              _this.DISBALE_BUTTON = true;
              wxlog.info('生成开始');
              uni.showLoading({
                mask: true,
                title: '生成开始' });_context4.prev = 4;


              wxlog.info('主进程：【开始】下载背景图');_context4.next = 8;return (
                downLoadAndSaveFile(_this.POSTER_IMAGE_INFO.posterImgDownloadUrl));case 8:savedFilePath = _context4.sent;
              ...
              uni.getImageInfo({
                ...
                fail: function fail(e) {
                  ...
                  reject(false);
                } });_context4.next = 21;break;case 14:_context4.prev = 14;_context4.t0 = _context4["catch"](4);


              _this.DISBALE_BUTTON = false;
              wxlog.error('主进程：{异常}', _context4.t0);
              uni.hideLoading();
              uni.showModal({
                title: '生成错误',
                content: JSON.stringify(_context4.t0) });

              reject(false);case 21:case "end":return _context4.stop();}}}, _callee4, null, [[4, 14]]);}));return function (_x7, _x8) {return _ref4.apply(this, arguments);};}());
...
/* 21 */
/*!*************************************************!*\
  !*** F:/HBuilderX/qrcode-to-poster/util/log.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 22 */
/*!**************************************************!*\
  !*** F:/HBuilderX/qrcode-to-poster/pages/log.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
